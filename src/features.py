...
# Horizons match configs/default.yaml → return_horizons
...
# Windows match configs/default.yaml → vol_windows
...
FINAL_COLS: tuple[str, ...] = (
    "date", "ticker", "price",
    "1d_log_ret", "21d_log_ret", "63d_log_ret", "126d_log_ret", "252d_log_ret",
    "1d_arith_ret", "21d_arith_ret", "63d_arith_ret", "126d_arith_ret", "252d_arith_ret",
